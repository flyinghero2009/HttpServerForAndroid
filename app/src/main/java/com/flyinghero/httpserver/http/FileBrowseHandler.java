package com.flyinghero.httpserver.http;
...
public class FileBrowseHandler implements HttpRequestHandler
{
            ...
            HttpContext httpContext) throws HttpException, IOException
    {
        ...
        String contentType = "application/json;charset=" + Constant.ENCODING;
        if(target.equals(Constant.Get_Ips)){
            httpResponse.setStatusCode(HttpStatus.SC_OK);
            String  msg = "{\"errcode\":200,\"data\":[123,345]}";
